...
export class XRayStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id:string) {
    ...
    const mysfitsPostQuestion = new lambda.Function(this, "PostQuestionFunction", {
      ...
      memorySize: 128,
      code: lambda.Code.fromAsset(assetLoader.getAssetPath("lambda-questions/PostQuestionsService")),
    ...
    topic.addSubscription(new subs.EmailSubscription(process.env.CONTACT_EMAIL || 'none@example.com'));
    ...
    const mysfitsProcessQuestionStream = new lambda.Function(this, "ProcessQuestionStreamFunction", {
      ...
      memorySize: 128,
      code: lambda.Code.fromAsset(assetLoader.getAssetPath("lambda-questions/ProcessQuestionsStream")),
      timeout: cdk.Duration.seconds(30),
      initialPolicy: [
